...
APPNAME=mtb-example-pmg1-ocp-scp-rcp
...
ifeq ($(TARGET), PMG1-CY7112)
	DEFINES+=VBUS_OCP_ENABLE=1 VBUS_SCP_ENABLE=0 VBUS_RCP_ENABLE=0
else
	DEFINES+=VBUS_OCP_ENABLE=1 VBUS_SCP_ENABLE=1 VBUS_RCP_ENABLE=1
endif
